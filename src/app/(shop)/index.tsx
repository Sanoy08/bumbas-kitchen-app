...
const AutoCarousel = ({ data, renderItem, autoPlayDelay = 4000, isAutoPlay = false }: any) => {
  ...
  return (
    <View>
      ...
      />
      {data.length > 1 && (
        <View className="flex-row justify-center mt-3 space-x-1.5 pb-2">
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 pb-20">
        ...
        <View className="py-8 px-4">
          ...
          <View className="h-72">
            <FlatList
              ...
              showsHorizontalScrollIndicator={false}
              renderItem={({ item }: any) => (
                <View style={{ width: windowWidth * 0.55 }} className="mr-3">
          ...
          <Link href="/menus" asChild>
            <TouchableOpacity className="mt-6 border border-primary/50 rounded-full py-3 mx-8 items-center">
        ...
        <View className="py-10 bg-slate-50">
          ...
          <AutoCarousel
            ...
            renderItem={(item: any) => (
              <View className="px-4">
                <View className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-2">
